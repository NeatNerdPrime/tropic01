...
|----------|-----------|----------|-------------|
| 2.1.0 | [A.11](../datasheet/ODD_TR01_datasheet_vA_11.pdf) | [1.4.0](../api/ODU_TR01_user_api_v1_4_0.pdf) | Fixed rare `Resend_Req` reliability issue affecting multi-chunk L3 results. Improved PTRNG reliability. No API changes. |
